...
const apiKey = "Sb23Hry5fK1wunSfsKGVr2IHZiCaaNRSzezJjRMr";  

// search base URL
const searchBaseURL = "https://api.si.edu/openaccess/api/v1.0/search";

// Constructing the search query
//const search =  `Bee AND unit_code:"CHNDM" AND object_type:"Embroidery (visual works)" AND online_media_type:"Images"`;
const search = `("Bee" OR "Butterfly" OR "Moth") AND unit_code:"NMNHENTO"`;
